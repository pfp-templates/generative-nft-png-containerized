...
def main():
    ...
    num_avatars = int(os.environ['NUM_AVATARS'])
    print("Creating %i avatars." % (num_avatars))

    edition_name = os.environ['EDITION_NAME']
    print("Edition will be called: %s" % (edition_name))
